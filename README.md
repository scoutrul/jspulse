...
- **`frontend`**
  ...
  - **Skeleton UI:** Библиотека компонентов и утилит на основе Tailwind CSS.
- **`shared`**
...
- **Интегрирована библиотека компонентов Skeleton UI** для ускорения разработки интерфейса.
